...
parser.add_argument('-b', '--batch-size', default=64, type=int, #256
                    metavar='N',
...
log_dir = '/media/d3-ai/E/cll/Results/MoCo/res50/log'

check_dir = '/media/d3-ai/E/cll/Results/MoCo/res50/checkpoint'
...
def main():
    ...
    args.save_path = '/media/d3-ai/E/cll/Results/MoCo/res50/'
    args.results_dir = '/media/d3-ai/E/cll/Results/MoCo/res50/' + datetime.now().strftime("%Y-%m-%d-%H-%M-%S-moco")
    if args.results_dir == '':
